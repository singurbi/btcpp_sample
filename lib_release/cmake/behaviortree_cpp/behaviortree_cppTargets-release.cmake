...
set_target_properties(BT::behaviortree_cpp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib_release/libbehaviortree_cpp.so"
  IMPORTED_SONAME_RELEASE "libbehaviortree_cpp.so"
  )

list(APPEND _cmake_import_check_targets BT::behaviortree_cpp )
list(APPEND _cmake_import_check_files_for_BT::behaviortree_cpp "${_IMPORT_PREFIX}/lib_release/libbehaviortree_cpp.so" )
